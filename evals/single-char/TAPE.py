...
def format_sequence_and_label(sequence, label, sp):
    ...
    """
    tokenized_seq = sp.EncodeAsIds("<protein>" + sequence + "<EOS>")
    ...
    with torch.no_grad():
        for i in range(len(X_test)):
            ...
            if single_target:
                ...
                truths_list.extend(y_label[:2048])
